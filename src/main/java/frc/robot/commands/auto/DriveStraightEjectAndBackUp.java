...
public class DriveStraightEjectAndBackUp extends SequentialCommandGroup {
    public DriveStraightEjectAndBackUp(DriveTrain driveTrain, Outtake outtake) {
        ...
        addCommands(new NoFinishOuttakeCommand(outtake, OuttakeSpeeds.RUNNING).
            ...
            addCommands(new DriveForTime(driveTrain, .3, .2, 1.1));
